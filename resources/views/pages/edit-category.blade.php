...
<div class="container">
    ...
    @isset($category)
    <form class="text-dark lead" action="{{asset('/update-category/'.$category->id)}}" id="update-category" method="POST" enctype="multipart/form-data">
    @csrf
    <h3>Here you can edit your category</h3>
           ...
           <br> 
            ...
            <div class="form-group">
                <h4>Edit a category name</h4>
                <input class="form-control" id="" type="text" name="name" value="{{$category->name}}">
