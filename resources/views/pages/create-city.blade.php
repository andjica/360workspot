...
<div class="container">
    ...
    <form class="text-dark lead" action="{{route('insert-city')}}" id="create-blog" method="POST" enctype="multipart/form-data">
    @csrf
    <h3>Here you Add a new City :)</h3>
           ...
           <br> 
            <div class="form-group">
                ...
                <input class="form-control" id="" type="text" name="name" placeholder="Amsterdam for example..">
